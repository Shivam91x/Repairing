      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card 
              key={index} 
              className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-gray-700 shadow-lg bg-gray-800/70 backdrop-blur-sm glow-blue hover:glow-cyan"
            >
              <CardHeader className="text-center pb-4">
                <div className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r ${service.color} flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300 glow-blue`}>
                  {service.icon}
                </div>
              ...
              <CardContent className="text-center">
                ...
                <div className="mt-6">
                  <button className="text-cyan-400 font-semibold hover:text-blue-400 transition-colors group-hover:underline">
                    Learn More →
                  </button>
                </div>
              </CardContent>
